...
The sprite folder carries 895 species, well past Gen 5's 649, because Smogon
kept drawing in the Black/White style. But it is not complete — Decidueye,
Cinderace and Meowscarada are all missing. `npm run roster` reports a miss
rather than failing quietly, so fetch a new entry before believing in it.
